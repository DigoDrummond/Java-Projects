public class MergeSortDecrescente {
    ...
    MergeSortDecrescente(int[] array) {
        this.array = array;
    }
    ...
    public void mergeSort(int esq, int dir) {
        if (esq < dir) {
            ...
            intercalacao(esq, meio, dir);
        }
    }

    public void intercalacao(int esq, int meio, int dir) {
        int nEsq = (meio + 1) - esq;
        int nDir = dir - meio;
    ...
    public static void main(String[] args) {
        ...
        MergeSortDecrescente a = new MergeSortDecrescente(array);
